...
do
	...
	echo $nmi-$seed $'\r' >> ./set2_results/1000_s_0.1_data
done
...
do
	...
	echo $nmi-$seed $'\r' >> ./set2_results/1000_s_0.2_data
done
...
do
	...
	echo $nmi-$seed $'\r' >> ./set2_results/1000_s_0.3_data
done
...
do
	...
	echo $nmi-$seed $'\r' >> ./set2_results/1000_s_0.4_data
done
...
do
	...
	echo $nmi-$seed $'\r' >> ./set2_results/1000_s_0.5_data
done
...
do
	...
	echo $nmi-$seed $'\r' >> ./set2_results/1000_s_0.6_data
done
...
do
	...
	echo $nmi-$seed $'\r' >> ./set2_results/1000_s_0.7_data
done
...
do
	...
	echo $nmi-$seed $'\r' >> ./set2_results/1000_s_0.8_data
done
